...
namespace Generator.Main
{
    ...
    /// کلاس اصلی جنریتور
    /// </summary>
    public class EntitiesCodeGenerator : BaseGenerator
    {
        ...
        public EntitiesCodeGenerator()
            : this(new EntityGenerator(), new ServiceGenerator(), new ViewGenerator(), new ControllerGenerator(), new GeneratorDatabaseCreator())
        { }
        ...
        {
            tableName = GeneratorDatabaseProcessor.Titles.Where(c => c.Single == tableInfo.TableName || c.Plural == tableInfo.TableName).FirstOrDefault();
        ...
        {
            GeneratorDatabaseProcessor.CompleteGeneratorDatabase();
        }
